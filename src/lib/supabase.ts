...
const supabaseUrl = (process.env.NEXT_PUBLIC_SUPABASE_URL || 'https://placeholder-domain-never-use.supabase.co').replace('qdozfcplmdqnnziurgn', 'qdozfcplmdqgnnziurgn');
